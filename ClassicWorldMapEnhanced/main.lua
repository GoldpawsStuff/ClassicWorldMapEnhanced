...
-- https://wow.tools/dbc/?dbc=uimap&build=2.5.1.38598
----------------------------------------------------
local zoneData = {
	...
	[1941] = { min = 1, max = 10, faction = "Horde" },  	-- Eversong Woods
	[1942] = { min = 10, max = 20, faction = "Horde" }, 	-- Ghostlands
	...
	-- Outland
	[1944] = { min = 58, max = 63 }, 						-- Hellfire Peninsula
	[1946] = { min = 60, max = 64 }, 						-- Zangarmarsh
	[1952] = { min = 62, max = 65 }, 						-- Terokkar Forest
	[1951] = { min = 64, max = 67 }, 						-- Nagrand
	[1949] = { min = 65, max = 68 }, 						-- Blade's Edge Mountains
	[1953] = { min = 67, max = 70 }, 						-- Netherstorm
	[1948] = { min = 67, max = 70 }, 						-- Shadowmoon Valley
	[1957] = { min = 70, max = 73 }, 						-- Isle of Quel'Danas
}

----------------------------------------------------------------------
-- wow.tools/api/export/?name=worldmapoverlay&build=2.5.1.38043
-- wow.tools/api/export/?name=worldmapoverlaytile&build=2.5.1.38043
----------------------------------------------------------------------
local zoneReveal = {
	[1194] = {
	...
	[1207] = {
		...
		["256:256:0:148"] = "2212593",
		["256:256:12:428"] = "270520",
		["256:256:148:384"] = "2212599",
		["256:256:17:310"] = "270529",
